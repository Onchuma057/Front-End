    ...
    <div className="container py-5">
      ...
      <div className="row mb-5 align-items-center animate-on-scroll">
        ...
        <div className="col-md-7">
          ...
          สวัสดีค่ะ หนูชื่ออรชุมา โจตา หรือ อร
หนูเป็นนักพัฒนาเว็บและนักออกแบบที่รักในการสร้างประสบการณ์ดิจิทัลที่ทั้งสวย ใช้งานง่าย และเข้าถึงได้สำหรับทุกคน

ปัจจุบันเรียนที่วิทยาลัยเทคนิคเชียงใหม่หนูได้พื้นฐานทั้งด้านเทคนิคและการออกแบบ จากวันนั้นจนถึงวันนี้ หนูมีโอกาสทำงานในโปรเจกต์หลากหลาย ทั้งเว็บบล็อกส่วนตัว เว็บแนะนำ
          </p>
          <p style={{ color: "#555", lineHeight: "1.8" }}>
          เว็บไซต์นี้จัดทำขึ้นในรายวิชา <b> การพัฒนาซอฟต์แวร์ด้วยเทคโนโลยี Frontend </b>
          โดยมีวัตถุประสงค์เพื่อเป็นโปรเจกต์เล็ก ๆ ส่งอาจารย์ และเป็นโอกาสให้ฉันได้ฝึกฝนทักษะการเขียนโค้ด การออกแบบ UI/UX และการพัฒนาเว็บไซต์จริงจากไอเดียสู่การใช้งานจริง
          </p>
          <div className="mt-4">
      ...
      <div className="row mb-5 animate-on-scroll">
        ...
        <div className="col-md-6">
          ...
          <p style={{ color: "#555", lineHeight: "1.8" }}>
          หนูกำลังศึกษาอยู่ที่วิทยาลัยเทคนิคเชียงใหม่ (CMTC) ในระดับประกาศนียบัตรวิชาชีพชั้นสูง (ปวส.) สาขาเทคโนโลยีคอมพิวเตอร์
